...
public class GameActivity extends AppCompatActivity {
    ...
    public void gameContinue(){
        ...
        number3 = random.nextInt(12);
        number4 = random.nextInt(12);

        intentForOperation = getIntent();
        operation = intentForOperation.getStringExtra("operation");
        if(operation.equals("addition")){
            ...
            Toast.makeText(this, "error:operation selection failed", Toast.LENGTH_SHORT).show();
        }
        startTimer();
    }
